import type { BtnVariant, Category } from "../types/types";

export const getBgColorClass = (category: Category): string => {
...
export const getBtnClass = (variant: string): string => {
...
export const getIconClass = (variant: string): string => {
